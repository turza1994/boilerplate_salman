        ...
        <div className='flex items-center gap-4'>
          ...
          <div className='flex items-center gap-2 pl-2 ml-2 border-l border-slate-200'>
            ...
            >
              <path
                fill='#666'
                d='M8 1a7 7 0 100 14A7 7 0 008 1zM6.5 5.5a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM8 12a4 4 0 01-3.465-2H4.5a.5.5 0 010-1h.535A4 4 0 018 7a4 4 0 012.965 1.5H10.5a.5.5 0 010 1h-.535A4 4 0 018 12z'
              />
            </svg>
            <select
              value={visibility}
              ...
              className='text-sm bg-transparent border-none cursor-pointer text-slate-600 focus:outline-none focus:ring-0'
            >
