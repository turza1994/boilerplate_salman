      ...
      <div className='p-6 transition-all duration-300 bg-white border rounded-lg border-slate-200 hover:shadow-md'>
        ...
        <div className='relative mb-6'>
          ...
          <input
            ...
            className='w-full py-2 pl-12 pr-4 text-sm border rounded-lg border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent'
          />
        </div>
