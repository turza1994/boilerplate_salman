export function MobileBottomNav() {
  return (
    <div className='fixed bottom-0 left-0 right-0 z-50 transition-all duration-300 bg-white border-t border-slate-200 md:hidden hover:shadow-lg'>
      <div className='flex items-center justify-around h-16'>
        {/* Home */}
        <a
          href='/feed'
          className='flex flex-col items-center justify-center flex-1 h-full text-blue-600 transition-all duration-200 hover:scale-110'
        >
          <svg
        ...
        <a
          href='/friends'
          className='flex flex-col items-center justify-center flex-1 h-full transition-all duration-200 text-slate-600 hover:scale-110 hover:text-blue-600'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='27'
        ...
        <a
          href='/notifications'
          className='relative flex flex-col items-center justify-center flex-1 h-full transition-all duration-200 text-slate-600 hover:scale-110 hover:text-blue-600'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='25'
        ...
        {/* Menu (Hamburger) */}
        <div className='flex flex-col items-center justify-center flex-1 h-full transition-all duration-200 hover:scale-110'>
